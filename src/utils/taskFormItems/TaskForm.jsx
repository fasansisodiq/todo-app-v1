function TaskForm({ header, onSubmit, children }) {
  return (
    <div className="relative w-60 h-100 sm:w-80 sm:h-150 md:w-100 md:h-150 lg:w-110 lg:h-150 xl:w-150 xl:h-full flex flex-col p-5 pb-10  gap-2 items-center justify-between xl:justify-center  capitalize text-slate-800    rounded-lg bg-[#c0efe3] shadow-2xl my-4">
      <h1

  ...
  return (
    ...
    `}
        ...
        >
          ...
          <div className="flex items-center justify-center min-w-[1rem] h-3.5 sm:min-w-[2rem] sm:h-7 rounded-full bg-emerald-100 dark:bg-[#232b25] text-emerald-700 dark:text-yellow-200 font-bold text-xs sm:text-sm shadow group-hover:bg-emerald-200 dark:group-hover:bg-[#181f1b] transition-colors duration-200">
            {taskNum}
          </div>
        </div>
      }

  ...
  return (
    <div className="flex">
      <TodoNavigator
        ...
        element={
          <button className="text-slate-700 dark:text-yellow-300 bg-white dark:bg-[#232b25] rounded-full p-2 shadow hover:bg-emerald-100 dark:hover:bg-[#181f1b] transition-colors duration-200 text-[0.8rem] md:text-lg lg:text-2xl xl:text-2xl">
            <BiPlus />
          </button>
        }
